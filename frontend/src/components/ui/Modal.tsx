...
export default function Modal({ children, isOpen, title, footer, onClose }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-200/45 px-4 py-8 backdrop-blur-sm">
      <Card className="max-h-[90vh] w-full max-w-4xl shadow-2xl">
